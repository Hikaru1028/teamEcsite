...
public class CreateUserConfirmAction extends ActionSupport implements SessionAware{
	...
	public String execute() {
		...
		InputChecker inputChecker = new InputChecker();//↓エラー一覧　何がtrueで何がfalseなのかはInputChecker見れる。
		...
		if(familyNameErrorMessageList.size() > 0//↑エラーが一つでもあれば、エラーにする
		...
		if (userInfoDAO.isExistsUserInfo(userId)) {  ////既にあるユーザーなら70行目 新ユーザーならSUCCESS。
